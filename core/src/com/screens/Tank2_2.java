...
public class Tank2_2 implements Screen {
...
//    ImageButton tank;
    private int tank1 ;
    public Tank2_2(MyGdxGame game, int tank1){this.game = game;
        this.tank1 = tank1;}
//    private Image tank1(){
...
//        tank1.setSize(600, 168*2);
        ...
        next.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y){
                game.setScreen(new GameScreenBox2d(game, Tank2_2.this.tank1, 2));
            }
        });
        ...
        buttonRight.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y){
                game.setScreen(new Tank2_3(game, 2));
            }
        });
