...
public class Tank1_3 implements Screen {
...
//    int counterold = 2;
//    ImageButton tank;
    public Tank1_3(MyGdxGame game){this.game = game;}
//    private Image tank1(){
...
//    }
    ...
    public void show() {
        ...
        Texture splashTexture = new Texture("tankbg.png");
        ...
        Texture texture = new Texture(Gdx.files.internal("tanks/tank3.png"));
        Image tank1 = new Image(texture);
        tank1.setSize(3*300, 4.7f*168);
        tank1.setPosition(Gdx.graphics.getWidth()/2-300*3/2, Gdx.graphics.getHeight()/2-168*4.7f/2-52-32);
...
//        tank1.setSize(600, 168*2);
        ...
        next.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y){
                game.setScreen(new Tank2_1(game, 3));
            }
        });
...
//        buttonLeft.setScale(0.20f);
        ...
        buttonLeft.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y){
                game.setScreen(new Tank1_2(game));
            }
        });

        Label.LabelStyle headingStyle = new Label.LabelStyle(white, Color.WHITE);

        heading = new Label("      Player 1 : Choose Tank      ",headingStyle);
