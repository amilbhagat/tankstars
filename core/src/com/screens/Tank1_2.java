...
public class Tank1_2 implements Screen {
...
//    int counterold = 2;
//    ImageButton tank;
    public Tank1_2(MyGdxGame game){this.game = game;}
//    private Image tank1(){
...
//    }
    ...
    public void show() {
        ...
        tank1.setPosition(Gdx.graphics.getWidth()/2-300*3/2, Gdx.graphics.getHeight()/2-168*4.7f/2-52);
...
//        tank1.setSize(600, 168*2);
        ...
        next.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y){
                game.setScreen(new Tank2_1(game, 2));
            }
        });
        ...
        buttonRight.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y){
                game.setScreen(new Tank1_3(game));
            }
        });
